  ...
  return (
    <>
      ...
      <div style={{ margin: '1em', width: '50%', }}> 
        ...
        My name is Edda Rabold, and I'm a designer located in Marseille who specializes in digital production technologies and unique design processes. 
        I graduated from Burg Giebichenstein in Halle with a degree in Industrial Design and studied at the Art and Design Academy Bezalel in Jerusalem.
